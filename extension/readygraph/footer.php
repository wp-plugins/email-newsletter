	...
	$(function () {
		...
		$("a.monetize").click(function() {
			...
			, success: function (response) {
					...
					jQuery.post(ajaxurl,{action : 'ee-myajax-submit',readygraph_monetize : "true",adsoptimal_id : monetize_adsoptimal_id, adsoptimal_secret : monetize_adsoptimal_secret},function() {});
		...
		$("a.connect").click(function() {
			...
			if (enable_monetize){
			$.post(ajaxurl,{action : 'ee-myajax-submit',readygraph_monetize : "true"},function() {});
