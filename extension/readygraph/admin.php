...
include("header.php");
	if (!get_option('readygraph_application_id') || strlen(get_option('readygraph_application_id')) <= 0)ee_rg_connect();
...
<div class="authenticate" style="display: none;">
	<div class="wrap1" style="min-height: 600px;">
		...
		<h2>We have enhanced <?php echo $ee_main_plugin_title ?> with ReadyGraph's Growth/Revenue Engine</h2>
...
<div class="authenticating" style="display: none;">
	<div style="color: #ffffff; width: 350px; margin: 100px auto 0px; padding: 15px; border: solid 1px #2a388f; text-align: center; background-color: #2961cb; -webkit-border-radius: 7px; -moz-border-radius: 7px; border-radius: 7px;">
		<h3 style="margin-top: 0px; font-weight: 300;"><?php echo $ee_main_plugin_title ?>, Now with ReadyGraph</h3>
		<h4 style="padding: 50px 0; line-height: 42px;">Retrieving Your Account..</h4>
		<p>Activate Readygraph features to optimize <?php echo $ee_main_plugin_title ?> functionality. Signup For These Benefits:</p>
		<p style="text-align: left; padding: 0 20px;">
...
<div class="authenticated" style="display: none;">
	...
	<div class="tutorial-true" style="margin: 5% auto;">
		<h3 style="font-weight: normal; text-align: center;"><img src="<?php echo plugin_dir_url( __FILE__ );?>assets/check.png"/>Congratulations! <?php echo $ee_main_plugin_title; ?>'s ReadyGraph growth engine is now active.</h3>
