...
ee_rrmdir($dir);
	...
	if(isset($_GET["action"]) && base64_decode($_GET["action"]) == "changeaccount")ee_changeAccount();
	if(isset($_GET["action"]) && base64_decode($_GET["action"]) == "deleteaccount")ee_deleteAccount();
