<div class="wrap">
  ...
  <?php
  	global $wpdb;
    $title = __('Email newsletter (Compose Email)');
    $mainurl = get_option('siteurl')."/wp-admin/options-general.php?page=email-newsletter/email-compose.php";
    $DID=@$_GET["DID"];
    $AC=@$_GET["AC"];
  ...
  <form name="form_eemail" method="post" action="<?php echo $mainurl; ?>" onsubmit="return eemail_submit()"  >
    <table width="100%">
      ...
      <tr>
        <td colspan="2" align="left" valign="middle">Enter email body</td>
      </tr>
      <tr>
        <td colspan="2" align="left" valign="middle"><textarea name="eemail_content" cols="100" rows="25" id="eemail_content"><?php echo $eemail_content_x; ?></textarea></td>
      </tr>
      <tr>
      ...
      <table width="100%" class="widefat" id="straymanage">
        ...
        <tbody>
          <tr class="<?php if ($i&1) { echo'alternate'; } else { echo ''; }?>">
			...
			<td align="left" valign="middle"><a href="options-general.php?page=email-newsletter/email-compose.php&DID=<?php echo($data->eemail_id); ?>">Edit</a> &nbsp; <a onClick="javascript:_eemail_delete('<?php echo($data->eemail_id); ?>')" href="javascript:void(0);">Delete</a> </td>
          </tr>
        </tbody>
        <?php $i = $i+1; } ?>
