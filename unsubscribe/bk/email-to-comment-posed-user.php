...
$sSql = "SELECT DISTINCT(comment_author_email) as user_email, `comment_author`,`comment_author_email` FROM ". $wpdb->prefix . "comments WHERE comment_author_email <> '' and comment_post_ID=310";
