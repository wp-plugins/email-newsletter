...
//	add_options_page('Email newsletter', '', 'manage_options', 'email-newsletter/email-to-subscriber.php','' );
}
...
{
  	register_sidebar_widget(__("Email newsletter"), 'eemail_widget');   
	
	if(function_exists('register_sidebar_widget')) 
	{
		register_sidebar_widget("Email newsletter", 'eemail_widget');
	}
	
	if(function_exists('register_widget_control')) 
	{
		register_widget_control(array("Email newsletter", 'widgets'), 'eemail_control');
	} 
}
...
{
	add_menu_page('Email Newsl...', 'Email Newsl...', 'administrator', 'email-newsletter', 'eemail_admin_option');
